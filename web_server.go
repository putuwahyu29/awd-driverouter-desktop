...
func NewWebServer(a *App) *WebServer {
	...
	if err != nil {
		userConfigDir = os.Getenv("APPDATA")
		if userConfigDir == "" {
			userConfigDir = os.Getenv("USERPROFILE")
		}
	}
	configDir := filepath.Join(userConfigDir, "driverouter")
...
func (ws *WebServer) Start() error {
	...
	mux.HandleFunc("/logo.png", ws.handleLogo)
