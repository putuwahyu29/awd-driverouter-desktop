...
export const IconEye = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>;
export const IconEyeOff = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.44-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.17c0-1.66-1.34-3-3-3l-.17.02z"/></svg>;
...
export const IconMega = () => (
  <svg viewBox="0 0 24 24" width="24" height="24">
    <circle cx="12" cy="12" r="10" fill="#d9272e" />
    <path fill="#ffffff" d="M7 8.5v7h2v-4.5l3 3 3-3v4.5h2v-7h-2.1l-2.9 2.9-2.9-2.9z" />
  </svg>
);

export const IconKoofr = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#00a3e0">
    <path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM10 17l-3.5-3.5 1.41-1.41L10 14.17l5.09-5.09L16.5 10.5 10 17z"/>
  </svg>
);

export const IconMediaFire = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#0070f0">
    <path d="M12 2S8.5 6.5 8.5 10c0 2.5 1.8 4.5 4 4.8-1.5-1.5-1.2-3.8.3-5.3 1.8 2.2 4.2 3.2 4.2 6.5 0 3.3-2.7 6-6 6s-6-2.7-6-6c0-4.5 4-8.5 7-14z"/>
  </svg>
);

export const Icon4Shared = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#0099ff">
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-4 8h-2v2h2v2h-2v2h-2v-2H9v-2h4v-2H9V7h6v4z"/>
  </svg>
);

export const IconB2 = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#e21c21">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2c1.1 0 2 .9 2 2 0 .7-.4 1.3-1 1.7.8.4 1.5 1.1 1.5 2.3 0 1.1-.9 2-2.5 2zm1-5c0-.6-.4-1-1-1v2c.6 0 1-.4 1-1zm.2 3.2c0-.7-.5-1.2-1.2-1.2v2.4c.7 0 1.2-.5 1.2-1.2z"/>
  </svg>
);

export const IconSmb = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#00a4ef">
    <path d="M4 6h16v10H4V6zm16-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h5v2H7v2h10v-2h-2v-2h5c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/>
  </svg>
);

export const IconFtp = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#ff9800">
    <path d="M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H5V8h14v10zm-7-9h-2v2h2V9zm0 4h-2v2h2v-2z"/>
  </svg>
);

export const IconSftp = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" fill="#4caf50">
    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-5.45 9-12V5l-9-4zm-1 14h2v2h-2v-2zm0-8h2v6h-2V7z"/>
  </svg>
);
